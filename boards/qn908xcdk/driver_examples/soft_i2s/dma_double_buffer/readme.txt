Overview
========
The dma with double buffer mode software_i2s_mic example shows how to use software
based i2s driver to create i2s timing and how to use spi functional API to do
double buffer based dma transfer as a slave and to receive microphone voice data:
